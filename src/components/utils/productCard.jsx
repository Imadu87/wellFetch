        ...
        {products?.map((product) => (
          ...
          >
            ...
            <div className="flex flex-col gap-[32px] items-center text-center">
              ...
              {/* Button */}
              <button className="w-[130px] h-[33px] px-[20px] py-[6px] flex items-center justify-center gap-[10px] rounded-[24px] border border-[#A37E65] text-[#A37E65] font-poppins font-semibold text-[14px] leading-[100%] hover:bg-[#A37E65] hover:text-white transition">
                Add to Cart
              </button>
