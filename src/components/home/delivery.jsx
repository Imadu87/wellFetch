...
export default function Delivery() {
  return (
    <section className="w-full overflow-visible flex justify-center bg-white">
      <div className="w-full min-h-[933px] p-6 sm:p-10 md:p-[80px] flex flex-col gap-10 md:gap-[80px] bg-[#191A20] overflow-visible">
        {/* HEADER */}
        <div className="flex flex-col gap-4 sm:gap-6 text-white text-center">
          <h2 className="font-abeezee font-normal text-[24px] sm:text-[36px] md:text-[52px] leading-[1.2]">
            Get Monthly Deliveries and <br />
            Save More
          </h2>
          <p className="font-poppins text-[14px] sm:text-[18px] md:text-[20px] text-gray-300">
            Never run out of your dog’s essentials again. Convenient, reliable,
            <br className="hidden sm:block" />
        ...
        {/* CARDS */}
        <div className="flex flex-col lg:flex-row gap-10 justify-center items-center overflow-visible">
          {plans.map((plan, index) => (
            <div
              key={index}
              className="
            ...
            >
              ...
              <div className="flex flex-col items-center gap-6 mt-6">
                <p className="font-poppins font-bold text-[28px] sm:text-[36px] text-white">
                  {plan.title}
                </p>
                <p className="font-poppins font-semibold text-[24px] sm:text-[32px] text-white">
                  {plan.price}
                </p>
              </div>
                  ...
                  (feature, i) => (
                    <div key={i} className="flex items-center gap-4">
                      <img
                        ...
                        className="w-5 h-5"
                      />
                      <p className="font-poppins text-[16px] sm:text-[18px] text-white">
                        {feature}
                      </p>
                    </div>
                  )
