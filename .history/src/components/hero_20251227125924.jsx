...
export default function Hero() {
  ...
  // );
  return (
    <section className="w-full flex justify-center bg-amber-300">
        ...
        <div className="w-full flex justify-center">
          <div className="w-full">
            ...
            <style>{`
              ...
              .hero-swiper .swiper-pagination-bullet-active { background: #D8A85B; transform: scale(1.15);margin: 0 120px; }
