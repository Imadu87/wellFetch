          ...
          <div className="w-full">
            ...
            >
              {slides.map((s) => (
                <SwiperSlide key={s}>
                  <div
                    className={`w-full aspect-[1440/485] sm:aspect-[1440/520] lg:aspect-[1440/560] bg-no-repeat bg-clip-content bg-[url('/hero/hero.png')]`}
                  />
                </SwiperSlide>
              ))}
            </Swiper>
            <style>{`
              ...
              .hero-swiper .swiper-pagination-bullet { width: 14px; height: 14px; opacity: 1; background: #111827; }
              .hero-swiper .swiper-pagination-bullet-active { background: #D8A85B; transform: scale(1.15); }
              @media (min-width: 640px) {
                .hero-swiper .swiper-pagination-bullet { width: 18px; height: 18px; }
              }
            `}</style>
          </div>
        </div>
