        ...
        <div className="w-full max-w-[1440px] relative">
          ...
          >
            ...
            <div className="w-full flex justify-center mt-10 md:mt-20 z-20 relative">
              {/* Parent */}
              <div className="w-[1280px] h-[284.14px] grid grid-cols-1 md:grid-cols-3 gap-20 relative">
                {/* Card 1 */}
                <div
                  className="w-[394px] h-[284.14px] rounded-[16px] relative bg-transparent"
                  style={{
                    borderWidth: "1.39px",
                    borderStyle: "solid",
                    borderImageSlice: 1,
                ...
                >
                  ...
                  >
                    WellFetch&apos;s AI vet helped me pick the right probiotic.
                ...
                >
                  ...
                  >
                    The subscription model is a lifesaver. I never run out of
                    the allergy chews, and Alfie has stopped scratching
                    completely!"
                  </p>
