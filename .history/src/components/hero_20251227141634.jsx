        ...
        <div className="w-full flex justify-center">
          <div className="w-full">
            ...
            <div className="hero-pagination-container mt-3 flex items-center justify-between max-w-[920px] mx-auto w-full px-4">
              <button
                aria-label="Previous"
                className="hero-prev flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-md"
              >
                <svg
                  width="16"
                  height="16"
              ...
              <button
                aria-label="Next"
                className="hero-next flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-md"
              >
                <svg
                  width="16"
                  height="16"
