...
export default function Products() {
  return (
    <section className="w-full flex justify-center mt-[10px] md:mt-[20px] lg:mt-[30px]">
      <div className="w-full max-w-[1440px] flex flex-col gap-[30px] px-[16px] md:px-[60px] lg:px-[80px] py-[40px]">

        {/* Section Header */}
        <div className="w-full flex flex-col sm:flex-row sm:items-center sm:justify-between gap-[16px]">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2  lg:grid-cols-4 gap-[40px]">
          ...
          {/* Product Card */}
          <div className="w-full max-w-[289px] mx-auto h-[507px] pt-[48px] px-[60px] pb-[52px] flex flex-col gap-[40px] border border-gray-300 rounded-[12px] bg-white">
